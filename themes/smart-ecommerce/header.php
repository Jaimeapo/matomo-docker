...
<div class="menu-overlay"></div>
	...
	<header id="masthead" class="site-header <?php //echo esc_attr(ecommerce_wp_get_header_style()); ?>" role="banner">
		...
		if ($ecommerce_wp_options['site_header_layout'] == 'storefront' && class_exists('WooCommerce')) { ?>
			...
			<div  class="header-storefront header-border">
				<div class="container">
					
					<?php 
						/* 
						 * header banner code start here 
						 */
						if ( is_active_sidebar( 'sidebar-header-banner' ) ) { ?>
						<div id="header-banner-area" class="row vertical-center">
							<?php dynamic_sidebar( 'sidebar-header-banner' ); ?>
						</div>
					<?php } ?>
			...
			<div id="theme-header" class="header-storefront menu header-border">
				<div class="container">
